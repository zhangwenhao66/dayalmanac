    ...
    "sections": [
      ...
      },
      {
        ...
        "body": [
          ...
          "Jean-Christophe Thery, founder of MusaArtGallery, routinely audits legal claims in campaign and press materials as part of his work in e-commerce and brand PR, and describes the fix as procedural rather than dramatic: \"Always verify the legislative record before stating an observance is 'federally recognized.' If Congress hasn't enacted a statute, use neutral language such as 'recognized by presidential proclamation' or simply 'observed nationally' until a law exists. When a mistake is found, correct the copy, issue a brief clarification to media and partners, and document the verification step in your PR checklist.\" That is close to the correction this page itself makes about the 2019 \"became a reality\" claim: name what actually happened (a committee vote, not a floor vote), rather than repeat the shorthand other coverage settled on."
        ]
      },
      {
