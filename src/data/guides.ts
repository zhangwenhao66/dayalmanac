  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": [
          "This calendar has now checked the federal paper trail behind several October and November health observances, and ADHD Awareness Month's pattern is the most unusual of the group so far. [American Diabetes Month](/diabetes-awareness-month/) has an actual presidential proclamation on record, Reagan's Proclamation 4994 in 1982, renewed by name again in 1985. [National Epilepsy Awareness Month](/epilepsy-awareness-month/) has the opposite record: three separate congressional resolutions, in 2002, 2003, and 2011, were introduced and every one of them died in committee without a vote. [Domestic Violence Awareness Month](/domestic-violence-awareness-month/) sits between those two: Congress designated it by name for one specific year, 1989, in a joint resolution, and went back and renewed that same one-year designation once more for 1991, but nothing has renewed it since, leaving every President since to keep proclaiming the month on independent executive authority.",
  ...
  },
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "body": [
          "This site has now checked the federal paper trail behind several awareness months, and the results form a rough spectrum rather than a single pattern. [Domestic Violence Awareness Month](/domestic-violence-awareness-month/) reached an actual congressional joint resolution behind a specific year, 1989's Public Law 101-112, and Congress went back and renewed that same one-year designation once more for 1991, but nothing has renewed it since. [ADHD Awareness Month](/adhd-awareness-month/) has a documented five-year run of Senate resolutions, 2004 through 2008, each agreed to without objection, before the practice simply stopped with no sixth attempt found. [Epilepsy Awareness Month](/epilepsy-awareness-month/) has the weakest record of the three: three separate resolutions across three different Congresses, and not one of them ever reached a vote in either chamber.",
